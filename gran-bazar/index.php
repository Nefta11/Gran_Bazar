    ...
    <header>
        <div class="menu-desktop">
            ...
            <div class="container-buttons">
                <h1 class="title-app">Gran Bazar</h1>
...
<?php
$stmt1 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 32,8');
...
<?php
$stmt2 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 40,8');
...
<?php
$stmt3 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 48,8');
...
<?php
$stmt4 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 56,8');
