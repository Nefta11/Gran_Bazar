...
<body>
    ...
    <div class="dropdown-content">
        ...
        <?php else: ?>
            ...
            <a href="cerrar_secion.php">Iniciar sesión</a>
    ...
    <main>
        ...
        <?php
        $stmt1 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 64,8');
        ...
        <?php
        $stmt2 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 72,8');
        ...
        <?php
        $stmt3 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 80,8');
        ...
        <?php
        $stmt4 = $pdo->query('SELECT * FROM tbb_productos WHERE ESTATUS = 1 LIMIT 88,8');
